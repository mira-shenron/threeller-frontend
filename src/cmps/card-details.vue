    ...
    <div class="card-details">
      <div class="header-card flex space-between">
        <div class="flex align-center">
          <img width="40px" src="../assets/card-icons/card.png" alt="" />
          <h2 v-if="!isShowEditName" @click="openNameEditor" class="card-title">
            {{ card.title }}
          </h2>
        ...
        <div class="main-content">
          <div class="flex warp label-member-date-to-show">
            ...
            <div v-if="card.labels">
              <card-details-labels :card="card"></card-details-labels>
            </div>
            <div>
